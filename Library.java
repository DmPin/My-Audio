...
public class Library
{
	...
	public void download(ArrayList<AudioContent> content)
	{
		...
		for(int i = 0; i < content.size(); i++)
		{
			...
			else if(content.get(i).getType().equals(AudioBook.TYPENAME))
			{
				...
				{
					System.out.println("AudioBook " + content.get(i).getTitle() + " already downloaded.");
				}
			}
  ...
  // Print the name of all artists. 
	...
	public void deleteSong(int index)
	{
		...
		{
			//throws Audio Not found exception if index is outside of range
   ...
   */
	...
	public void makePlaylist(String title)
	{
		...
		{
			//throws exception if a playlist with inputted title already exist
	...
	public void printPlaylist(String title)
	{
		...
		if (index == -1)
		{
			//throws ex if playlist with inputted name does not exist
    ...
    int plIndex = playlists.indexOf(new Playlist(playlistTitle));
		...
		{
			//throws ex if invalid content num is given
			throw new PlaylistNotFoundException("Invalid Playlist Content#.");
		}
  ...
  // Delete a song/audiobook/podcast from a playlist
	...
	public void delContentFromPlaylist(int index, String playlistTitle)
	{
		...
		{
			//throws ex if request content is not found in the playlist
...
class DuplicatePlaylistException extends RuntimeException
{
	...
	public DuplicatePlaylistException(String msg)
	{
		super(msg);
	}
}
...
class ContentNotInStoreEx extends RuntimeException
{
	public ContentNotInStoreEx(){}

	public ContentNotInStoreEx(String msg)
	{
		super(msg);
	}
}
